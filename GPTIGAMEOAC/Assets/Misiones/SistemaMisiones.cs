...
public class SistemaMisiones : MonoBehaviour {
    ...
    //         {
    //             nextMission = missions[currentMissionIndex];
    //             SetCurrentMission();
    //             nextMission.SetActive(true);
    //         }
    //         else
    ...
    // {
    //     actualMission = missions[currentMissionIndex];
    //     missionTitle = actualMission.GetComponent<MissionInfo>().title;
    //     missionDescription = actualMission.GetComponent<MissionInfo>().description;
    //     // Agrega cualquier otra información de la misión que desees mostrar.
    // }
